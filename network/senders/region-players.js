...
module.exports.send = (session, id) => {
    ...
    // modifying a collection while iterating over it... uh... this could cause
    // problems. unless node makes a copy of the array, then this is fine.
    for (const unknown of players.unknown) {
        ...
        // i think this type of update is actually to update if a player moved
        // or added, and this bit determines whether the player is a new and
        // being added or an existing player being updated
        // 0 == new, 1 == updated?
        packet.addBits(0, 1)
